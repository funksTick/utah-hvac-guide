          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <input value={form.phone} onChange={e => set('phone', e.target.value)}
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#e85d26]/50 placeholder-white/20"
                placeholder="(385) 486-0072" type="tel" />
            </div>
            <div className="mb-4">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => setStep(3)} disabled={!form.firstName || !form.lastName || !form.phone || !form.smsOptIn}
        ...
        {step === 3 && (
          <div>
            ...
            <p className="text-center text-white/20 text-xs mt-4">
              No spam. We'll contact you within 30 minutes.<br />
