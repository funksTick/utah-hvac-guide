    ...
    <main className="min-h-screen bg-[#0a0f1e] text-white font-sans">
      ...
      <nav className="border-b border-white/10 px-6 py-4 flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-white/60">
          ...
          <Link href="/sizing-calculator" className="hover:text-white transition-colors">Size My System</Link>
          <Link href="/#check-quote" className="hover:text-white transition-colors">Rate My Quote</Link>
      ...
      {/* Hero */}
      <section className="max-w-6xl mx-auto px-6 pt-20 grid lg:grid-cols-2 gap-16 items-center">
        <div>
      ...
      {/* Tools */}
      <section className="max-w-6xl mx-auto px-6 py-16 border-t border-white/10">
        <h2 className="text-2xl font-bold mb-2">Free Homeowner Tools</h2>
        <p className="text-white/50 mb-8">Know before you call. Our tools help you make smarter HVAC decisions.</p>
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/sizing-calculator" className="group bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-[#e85d26]/40 hover:bg-[#e85d26]/5 transition-all">
            <div className="text-2xl mb-3">📐</div>
            <h3 className="font-black text-lg mb-2 group-hover:text-[#e85d26] transition-colors">System Sizing Calculator</h3>
            <p className="text-white/50 text-sm">Answer a few questions and get a Manual J estimate — the same method contractors use to size your system.</p>
            <div className="text-[#e85d26] text-sm mt-4 opacity-0 group-hover:opacity-100 transition-opacity">Calculate my system size →</div>
          </Link>
          <Link href="/check-quote" className="group bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-[#e85d26]/40 hover:bg-[#e85d26]/5 transition-all">
            <div className="text-2xl mb-3">🔍</div>
            <h3 className="font-black text-lg mb-2 group-hover:text-[#e85d26] transition-colors">AI Quote Checker</h3>
            <p className="text-white/50 text-sm">Got a quote from a contractor? Enter the price and we'll instantly tell you if it's fair based on real Utah market rates.</p>
            <div className="text-[#e85d26] text-sm mt-4 opacity-0 group-hover:opacity-100 transition-opacity">Check my quote →</div>
          </Link>
        </div>
      </section>
      {/* Quote Checker Embed */}
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-center text-white/30 text-sm max-w-6xl mx-auto">
        ...
        <div className="flex justify-center gap-6 mt-3 text-white/20">
          ...
          <Link href="/check-quote" className="hover:text-white/40 transition-colors">Rate My Quote</Link>
        </div>
      </footer>
    </main>
  );
